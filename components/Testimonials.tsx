...
const TestimonialCard = ({ name, location, review, rating, img }: {name: string, location: string, review: string, rating: number, img: string}) => {
  return (
...
const Testimonials = () => {
  return (
    <div className="relative w-full py-12 bg-gray-100 dark:bg-gray-900">
      <div className=" text-center">
        ...
        <Marquee pauseOnHover className="flex space-x-6">
