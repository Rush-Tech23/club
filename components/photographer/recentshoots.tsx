...
const RecentShoots = () => {
  ...
  const GalleryModal = ({
    ...
    return (
      ...
      >
        <div className="bg-white dark:bg-neutral-900 rounded-xl max-w-5xl w-full p-6 relative">
          <button
            onClick={onClose}
  ...
  return (
    <section className="bg-gray-100 dark:bg-neutral-950">
      <div className="max-w-[1200px] mx-auto py-4 px-4 space-y-6">
        <div className="text-3xl md:text-4xl text-center font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {recentShoots.map((shoot, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-gray-700 rounded-xl bo shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
